    ...
    <div id="app">
        ...
        <div class="page-wrapper">
                            ...
                            <ul class="navbar-mobile__list list-unstyled">
                                <li class="has-sub">
                                    <a class="js-arrow" href="#">
                                        <i class="fas fa-tachometer-alt"></i>Sistema Taquería</a>
                                ...
                                <li>
                                    <a href="chart.php">
                                        <i class="fas fa-chart-bar"></i>Gráficas</a>
                                </li>
                                <li>
                                    <a href="table.php">
                                ...
                                <li>
                                    <a href="#">
                                        <i class="fas fa-calendar-alt"></i>Calendarios</a>
                                </li>
                                <li>
                                    <a href="map.php">
                                    ...
                                    <div class="header-button">
                                        ...
                                        <div class="account-wrap">
                                            <div class="account-item clearfix js-item-menu">
                                                ...
                                                <div class="content">
                                                    <a class="js-acc-btn" href="#">Israel Cabrera</a>
                                                </div>
                                                <div class="account-dropdown js-dropdown">
                                                    <div class="info clearfix">
                                                        ...
                                                        <div class="content">
                                                            <h5 class="name">
                                                                <a href="#">Israel Cabrera</a>
                                                            </h5>
                                                            <span class="email">isra_01@gmail.com</span>
                                                        </div>
                                                    </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="copyright">
                        <p>Copyright © 2018 Sergio Rivera. All rights reserved. Template by <a href="https://colorlib.com">Rivera</a>.</p>
                    </div>
                </div>
             </div>
